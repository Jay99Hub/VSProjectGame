...
public class Level : MonoBehaviour
{
    ...
    internal void AddUpgradesIntoTheListOfAvaiableUpgrades(List<UpgradeData> upgradesToAdd)
    {
    ...
    private void Start()
    {
        experienceBar.UpdatedExperienceSlider(experience, TO_LEVEL_UP);
        experienceBar.SetLevelText(level);
        AddUpgradesIntoTheListOfAvaiableUpgrades(upgradesAvailableOnStart);
    }
    ...
    public void Upgrade(int selectedUpgradeId)
    {
        ...
        switch (upgradeData.upgradeType)
        {
            ...
            case UpgradeType.ItemGet:
                ...
                AddUpgradesIntoTheListOfAvaiableUpgrades(upgradeData.item.upgrades);
                break;
        }
